...
\begin{itemize}
	...
	\begin{figure}[h]
		...
		\end{minipage}
		\caption{Example of combination of two approaches. The red dots indicate where the reinforcement learning approach guides at a high level. The figure on the right show the path found with combinatorial optimization in the restricted area around the train.}
